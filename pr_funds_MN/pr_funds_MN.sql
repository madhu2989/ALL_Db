...
create table fund_collection_new(
id int identity (500,1) primary key,
name varchar(25),
mobile_no bigint,
loan_amnt money default 0,
balance_amt money default 0,
no_ofdue int default 0,
dt datetime)

select *from fund_collection_new
update fund_collection_new set balance_amt=44000,no_ofdue=0 where id=500
...
select DateDiff(week,('2018-08-05 00:00:00.000'),'2018-08-19 00:00:00.000') as 'No_ofWeek'
...
select *from fund_login
insert into fund_login values('g','g',2,'Madhu')
